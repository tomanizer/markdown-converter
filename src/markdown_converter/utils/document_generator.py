...
class DocumentGenerator:
    ...
    def create_document(self, doc_type: str, content: Dict[str, Any], output_path: Path) -> None:
        """
    ...
    def _create_excel_document(self, content: Dict[str, Any], output_path: Path) -> None:
...
{content.get('body', '<h1>Test Document</h1><p>This is a test document.</p>')}
    ...
    def _create_outlook_document(self, content: Dict[str, Any], output_path: Path) -> None:
