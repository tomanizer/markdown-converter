...
class PandocParser(BaseParser):
    ...
    def _setup_default_config(self) -> None:
        ...
        self.default_config = {
            ...
            "supported_formats": [
                # Document formats
                '.docx', '.html', '.htm', '.rtf', '.odt', '.epub',
                # Markup formats  
                '.md', '.markdown', '.rst', '.org', '.textile', '.mediawiki',
                # Data formats
                '.csv', '.tsv',
                # Notebook formats
                '.ipynb',
    ...
    def convert_file(self, input_path: Union[str, Path], 
        ...
        # Setup options
        conversion_options = self.default_config["pandoc_config"]["markdown_settings"].copy()
        if options:
    ...
    def validate_format_support(self, input_format: str, output_format: str) -> bool:
        ...
        return (input_format in formats and 
                output_format in ['markdown', 'md'])
    ...
    def _extract_metadata(self, file_path: Path, conversion_info: Dict[str, Any]) -> Dict[str, Any]:
        """
